...
const ICONE: Record<string, { etichetta: string; path: string; viewBox?: string }> = {
  instagram: {
    etichetta: 'Instagram',
            ...
            <div className="flex flex-wrap items-center gap-4 mt-4 pt-4 border-t border-white/10">
              ...
              {scheda.email && (
                <a
                  ...
                  className="font-montserrat text-[12px] text-white/70 hover:text-lc-red transition-colors duration-200"
                >
                  {scheda.email}
                </a>
              )}
