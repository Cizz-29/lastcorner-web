...
const F2_TEAMS: RosterTeamEntry[] = [
  { id: 'invicta-racing', name: 'Invicta Racing', nationality: 'British', drivers: [
  ...
  { id: 'dams-lucas-oil', name: 'DAMS Lucas Oil', nationality: 'French', drivers: [
  ...
  { id: 'aix-racing', name: 'AIX Racing', nationality: 'Emirati', drivers: [
  ...
  { id: 'van-amersfoort-racing', name: 'Van Amersfoort Racing', nationality: 'Dutch', drivers: [
  ...
  { id: 'trident', name: 'Trident', nationality: 'Italian', drivers: [
...
function buildRoster(teamEntries: RosterTeamEntry[]): { drivers: RosterDriver[]; teams: RosterTeam[] } {
  ...
  for (const t of teamEntries) {
    teams.push({ constructorId: t.id, name: t.name, nationality: t.nationality })
